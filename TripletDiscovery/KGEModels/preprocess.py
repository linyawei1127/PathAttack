...
def parse_arguments():
    parser = argparse.ArgumentParser(description="Process knowledge graph data.")
    parser.add_argument('--add', action='store_true', default=False, 
                        help="Enable filtering of unseen entities. Default is False.")
    parser.add_argument('--dataset_name', type=str, default='WN18RR',
                        help="Name of the dataset (default: WN18RR).")
...
filter_unseen = False # if needed, pass as cmd argument
if filter_unseen:
